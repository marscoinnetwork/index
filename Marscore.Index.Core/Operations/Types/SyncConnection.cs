   ...
   public class NetworkConfig : Network
   {
      public NetworkConfig(IndexerSettings config, ChainSettings chainConfig, NetworkSettings networkConfig)
      {
         CoinTicker = chainConfig.Symbol;
            ...
            var ass = System.Reflection.Assembly.LoadFrom(AppDomain.CurrentDomain.BaseDirectory+"Marscore.Networks.X1.dll");
            var consensusFactory = (ConsensusFactory)ass.CreateInstance("Marscore.Networks.X1.Consensus.X1ConsensusFactory");
