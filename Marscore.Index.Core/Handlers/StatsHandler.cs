...
namespace Marscore.Index.Core.Handlers
{
   ...
   public class StatsHandler
   {
         ...
         if (syncConnection.HasNetworkType)
         {
            ...
            coinInfo.Configuration = new NetworkInfo
            {
               ...
               Consensus = new ConsensusInfo
               {
                  ...
                  PremineReward = consensus.PremineReward.ToUnit(Marscore.NBitcoin.MoneyUnit.BTC),
                  ProofOfStakeReward = consensus.ProofOfStakeReward.ToUnit(Marscore.NBitcoin.MoneyUnit.BTC),
                  ProofOfWorkReward = consensus.ProofOfWorkReward.ToUnit(Marscore.NBitcoin.MoneyUnit.BTC),
      ...
      // This code is temporary til Marscore upgrades to netcore 3.3
