...
namespace Blockcore.Index.Core.Handlers
{
   /// <summary>
   ...
   public class StatsHandler
   {
         ...
         if (syncConnection.HasNetworkType)
         {
            ...
            coinInfo.Configuration = new NetworkInfo
            {
               ...
               Consensus = new ConsensusInfo
               {
                  ...
                  PremineReward = consensus.PremineReward.ToUnit(Blockcore.NBitcoin.MoneyUnit.BTC),
                  ProofOfStakeReward = consensus.ProofOfStakeReward.ToUnit(Blockcore.NBitcoin.MoneyUnit.BTC),
                  ProofOfWorkReward = consensus.ProofOfWorkReward.ToUnit(Blockcore.NBitcoin.MoneyUnit.BTC),
      ...
      // This code is temporary til XOuranos upgrades to netcore 3.3
