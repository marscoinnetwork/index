...
namespace Blockcore.Index.Core.Storage.Mongo
{
   public class MongoData : IStorage
   {
      ...
      public QueryTransaction GetTransaction(string transactionId)
      {
         ...
         var result = new QueryTransaction
         {
            ...
            Inputs = transactionItems.Inputs.Select(i => new QueryTransactionInput
            {
               ...
               ScriptSigAsm = new Script(Blockcore.NBitcoin.DataEncoders.Encoders.Hex.DecodeData(i.ScriptSig)).ToString(),
            ...
            Outputs = transactionItems.Outputs.Select(o => new QueryTransactionOutput
            {
               ...
               ScriptPubKeyAsm = new Script(Blockcore.NBitcoin.DataEncoders.Encoders.Hex.DecodeData(o.ScriptPubKey)).ToString()
            }),
         };
      ...
      public SyncTransactionItems TransactionItemsGet(string transactionId, Transaction transaction = null)
      {
         ...
         int size = Blockcore.NBitcoin.BitcoinSerializableExtensions.GetSerializedSize(transaction, syncConnection.Network.Consensus.ConsensusFactory) ;
